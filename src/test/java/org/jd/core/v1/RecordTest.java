...
public class RecordTest extends AbstractJdTest {
    ...
    public void testRecordInstanceOfPatternMatching() throws Exception {
        test("/jar/jdk-pattern-matching-new-syntaxes-21.0.8.jar", "org/jd/core/v1/stub/RecordInstanceOfPatternMatching", "/txt/RecordInstanceOfPatternMatching.txt", "21", new StringBuilderPrinter());
    }
